...
if __name__ == "__main__":
    ...
    root_result='/afs/cern.ch/work/d/damorim/work/DELPHI_results/'+machine+'/BS_coll_interconnects_'+Estr+'V1';
    ...
    collSettingsFileName='collgaps_inj3.3TeV.dat'
    ...
    for imat,material in enumerate(materialscan):
	    ...
	    #        nb_holes_per_crosssection=nb_holes_per_cs,Cm=1.,Ce=1.)
	        ...
	        comment='LHCcoll',dire='FCChh_BS_coll_'+Estr+'/');
