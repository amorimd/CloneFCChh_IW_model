...
if __name__ == "__main__":
    ...
    root_result='/afs/cern.ch/work/d/damorim/work/DELPHI_results/'+machine+'/Interconnects_only_'+Estr+'V1';
    ...
    for imat,material in enumerate(materialscan):
	    ...
	    #    comment='LHCcoll',dire='FCChh_BSCH_'+Estr+'/');
            ...
            fpar2=freq_param(fmin=1,fmax=1e14,ftypescan=2,nflog=500,fminrefine=3.0e9,fmaxrefine=3.1e9,nrefine=1000000)
